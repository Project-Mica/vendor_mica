...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	$(hide) tar xfp vendor/mica/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	prebuilts/tools-mica/${HOST_OS}-x86/bin/mogrify -resize $$RESOLUTION -colors 256 $(INTERMEDIATES)/*/*.png; \
	echo "$$IMAGESCALEWIDTH $$IMAGESCALEHEIGHT 60" > $(INTERMEDIATES)/desc.txt; \
	cat vendor/mica/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
